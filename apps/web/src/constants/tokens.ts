...
export function isAnime(chainId: number): chainId is UniverseChainId.AnimeTestnet | UniverseChainId.AnimeTestnet {
  return chainId === UniverseChainId.AnimeTestnet || chainId === UniverseChainId.AnimeTestnet
}
