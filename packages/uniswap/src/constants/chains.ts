...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  ...
  [UniverseChainId.Zero]: {
    ...
    blockPerMainnetEpochForChainId: 12,
    blockWaitMsBeforeWarning: 600000,
    bridge: 'https://relay.link/bridge/zero-network',
    chainPriority: 0,
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://info.reservoir.app/#/zero',
    infuraPrefix: undefined,
    interfaceName: 'zero',
    label: 'Zero Mainnet',
    logo: ABSTRACT_LOGO,
  ...
  [UniswapSDKChainId.CYBER]: {
    ...
    blockPerMainnetEpochForChainId: 12,
    blockWaitMsBeforeWarning: 600000,
    bridge: 'https://www.relay.link/bridge/cyber',
    chainPriority: 0,
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://info.reservoir.app/#/cyber',
    infuraPrefix: undefined,
    interfaceName: 'cyber',
    label: 'Cyber',
    logo: CYBER_LOGO,
  ...
  [UniswapSDKChainId.REDSTONE_GARNET]: {
    ...
    blockPerMainnetEpochForChainId: 12,
    blockWaitMsBeforeWarning: 600000,
    bridge: 'https://testnets.relay.link/bridge/garnet',
    chainPriority: 0,
    docs: 'https://redstone.xyz',
    elementName: ElementName.ChainOptimism,
    explorer: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://testnets-info.reservoir.tools/#/garnet-holesky',
    infuraPrefix: undefined,
